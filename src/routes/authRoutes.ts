...
authRouter.post("/register", validateInput(userRegisterSchema), asyncErrorHandler(authController.register))
...
authRouter.post("/login", validateInput(userLoginSchema), asyncErrorHandler(authController.login))
